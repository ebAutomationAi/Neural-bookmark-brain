# app/services/scraper.py - VERSIÓN RESILIENTE ACTUALIZADA
...
class ResilientScraper:
    ...
    def extract_clean_title(self, original_title: str, domain: str = None) -> str:
        ...
        try:
            ...
            logger.error(f"Error extrayendo título limpio: {e}")
            return original_title if original_title else "Título Desconocido"
